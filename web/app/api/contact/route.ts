...
import { contactRequestSchema, contactResponseSchema } from "@/lib/schemas";
...
export async function POST(req: NextRequest) {
	...
	try {
		...
		if (isJson) {
			const validated = contactResponseSchema.parse(payload);
		...
		return NextResponse.json(
			{
				error: "[API_CONTACT] Unexpected error",
